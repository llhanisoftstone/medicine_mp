  ...
  <div class="container">
    ...
    <div class="itemlist" v-if="seen">
      <ul>
        <li @click="toreverse(i)" :class="{active:v.isreverse}" v-for="(v,i) in goods" :key="v.id">
          <div class="item_z" :style="{'opacity':v.isreverse_z==1?0:1}">
          ...
          <div class="item_reverse" @click.stop="toreverse(i)" :style="{'opacity':v.isreverse_z==1?1:0}">
    ...
    <div class="model" v-if="ishidden" @click="show1()">
      <div class="centermodel" @click.stop="show()">
        ...
        <ul>
          <li>
            <div class="toolname">{{toolname}}<span class="kuohao">( </span><span class="number_right">{{name_type}}<span class="show" v-if="istotalpoint">{{amount*20}}</span><span class="show" v-if="istotalprice">{{(amount*2)/10}}</span></span><span class="kuohao"> )</span></div>
